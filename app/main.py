...
from app.routers import map as map_router, qrcode, tickets, queues, emergency  # noqa: E402
...
app.include_router(map_router.router, prefix="/v1")
app.include_router(qrcode.router, prefix="/v1")
app.include_router(tickets.router, prefix="/v1")
app.include_router(queues.router, prefix="/v1")
